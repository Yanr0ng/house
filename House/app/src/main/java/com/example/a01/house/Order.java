...
public class Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.recycle_oc);
        getData();
    }
    public class ViewAdapter extends RecyclerView.Adapter<ViewAdapter.MyViewHolder> {
        ...
        public ViewAdapter(Context context, List<OrderList> mData) {
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            holder.oc_cusername.setText(name);//(String.valueOf(orderList.getCuserid()));
            ...
            holder.oc_ostatus.setText(String.valueOf(orderList.getOstatus()));//("/"+String.valueOf(orderList.getOstatus()));
        }
    ...
    public void getData() {
        JSON_URL="http://140.126.146.26/chu/api/order/find/"+cuserid;
