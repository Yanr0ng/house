...
public class StoreMember1 {
    ...
    public StoreMember1(String stars) {
        this.stars = stars;
    ...
    public StoreMember1(int sid, String suserid, String spwd, String sname, String sphone, String semail, String saddress, String shour, String sinf, String sstatus, String sreport, String sphotoname, String sphotopath) {
        this.sid = sid;
